...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style>img[src="blocker"],img[src="blocker"]{display:none!important}</style></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">" Based on
